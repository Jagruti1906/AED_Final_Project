 ...
 * @author admin
 */
public class SchoolAdminMain extends javax.swing.JFrame {

    /**
     * Creates new form SchoolAdminMain
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SchoolAdminMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SchoolAdminMain().setVisible(true);
            }
        });
    }
